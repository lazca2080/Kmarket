...
//		try {
//			logger.info("selectLatests...notice");
//			
//			Connection con = DBCP.getConnection();
//			PreparedStatement psmt = con.prepareStatement(CsSql.SELECT_NOTICE_LATESTS);
...
//	public List<CsVO> selectLatests2(String cate1, String cate2, String cate3){
//		List<CsVO> latests2 = new ArrayList<>();
//		try {
//			logger.info("selectLatests...qna");
//			Connection con = DBCP.getConnection();
//			PreparedStatement psmt = con.prepareStatement(CsSql.SELECT_QNA_LATESTS);
//			psmt.setString(1, cate1);
//			psmt.setString(2, cate2);
//			psmt.setString(3, cate3);
//			ResultSet rs = psmt.executeQuery();
