                ...
                <section>
                    ...
                    <table>
                        ...
                        <tr class="row">
                            ...
                            <td><a href="/Kmarket/admin/cs/faq/view.do?cate=faq&cateType1=${article.cateType1}&no=${article.no}">[${article.cateType2}] ${article.title} // type1:${article.cateType1} // type2:${article.cateType2} // no:${article.no}</a></td>
                    ...
                    <a href="/Kmarket/admin/cs/faq/write.do?cate=faq" class="write">작성하기</a>
                    <div class="paging">
                        <span class="prev">
                        ...
                        <span class="next">
                        	<c:if test="${pageGroupStart lt lastPageNum}">
                            	<a href="/Kmarket/admin/cs/faq/list.do?cate=faq&pg=${pageGroupStart+1}" class="next">다음&nbsp;></a>
                            </c:if>
                        </span>
                    </div>
                </section>
